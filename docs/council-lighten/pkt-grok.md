...
## YOUR LENS — THE DEMOLITION CREW
Be ruthless. Assume the author is sentimentally attached to text that earns nothing. Your job
is the biggest honest number: what is the MOST weight that can come out while a stranger
installing this method still behaves correctly? Say plainly which of your own cuts you are
least sure about — a demolition crew that cannot name its risky wall is not one.

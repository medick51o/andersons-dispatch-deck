...
## YOUR LENS — PRECISION AND CROSS-REFERENCE INTEGRITY
Verify every internal pointer against the actual headings present in the numbered text.
Then hunt compressions: paragraphs whose entire operative content is one sentence. Quote
the one sentence that survives.

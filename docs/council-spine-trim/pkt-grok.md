...
## YOUR LENS — ADVERSARIAL / ENFORCEMENT
Read as someone who wants to BREAK this method. Where is a rule stated so many times that
an orchestrator could obey one phrasing and violate another? Where does volume hide a gap?
Prioritize contradictions and dead references over raw line count.
